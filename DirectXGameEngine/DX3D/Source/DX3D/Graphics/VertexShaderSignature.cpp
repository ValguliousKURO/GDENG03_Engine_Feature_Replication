...
{
	if (!desc.vsBinary) DX3DLogThrowErrorInvalidArg("No Shader Binary Provided!");
	if (desc.vsBinary->getType() != ShaderType::VertextShader) DX3DLogThrowErrorInvalidArg("The 'vsBinary' is not a valid vertex shader binary");
