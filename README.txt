...
Based on PardCode's C++ 3D Game Engine tutorial series:
...
The Unity script supports primitive objects, transforms, enabled/disabled state, rigid body data, and scene export back to the same .level JSON schema.
...
The Unreal script supports primitive/static mesh actors, transforms with editor-to-Unreal axis conversion, enabled/visibility state, rigid body/physics simulation state, and scene export back to the same .level JSON schema.
